...
resource "aws_api_gateway_deployment" "fiap_burger_deployment" {
  depends_on = [
    ...
    aws_api_gateway_integration_get.clientes_integration_get,
    aws_api_gateway_integration_get.pedidos_integration_get,
    aws_api_gateway_integration_get.produtos_integration_get,
    aws_api_gateway_integration_get.categorias_integration_get
  ]
  rest_api_id = aws_api_gateway_rest_api.fiap_burger_api.id
  stage_name  = "prod"
}
